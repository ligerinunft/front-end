...
import nftContract from "../artifacts/LigerInu.sol/LigerInu.json";
    ...
    return (
        <section>
                ...
                <div className="roadmap-container"  >
                    ...
                    <div className='info-container'>
                        ...
                        <Table responsive>
                            <tbody>
                                <tr>
                                    <td className='p-2'>Your Liger Inu's </td>
            ...
            <section className='my-items'>
                {userNfts.length !== 0 ? (
                    <>
                        <h2 className="minttitle title text-center">My Liger Inu's</h2>
